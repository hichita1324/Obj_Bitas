...
//CreateTimes : 06/04/2016 08:28:46.AM

namespace Bitas
{
	public class KeysList_DM_LoaiCK
	{
		//ListAll
		public List<Ob_DM_LoaiCK> _ListAll(SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				...
				CommandText = @"Select MaLoaiCK, MoTa From DM_LoaiCK"
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
				Ob_DM_LoaiCK ob = new Ob_DM_LoaiCK();
				if(reader[0] != DBNull.Value){ ob.MALOAICK = Convert.ToString(reader[0]);}
		...
		//ListAll
		public List<Ob_DM_LoaiCK> _ListAll_sp(string StoredName, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//Insert ob
		public bool _InsertOb(Ob_DM_LoaiCK ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into DM_LoaiCK (MaLoaiCK, MoTa) Values(@MaLoaiCK, @MoTa)"
			};
			if (ob.MALOAICK.Trim() == "")
		...
		public bool _DeleteWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Delete From DM_LoaiCK Where " + condition
			};
			try
			{
				command.ExecuteNonQuery();
		...
		public bool _CheckWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select * From DM_LoaiCK Where " + condition
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Count(string nameColumn, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From DM_LoaiCK"
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _CountWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From DM_LoaiCK Where " + keyword +""
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Min(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From DM_LoaiCK"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MinWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From DM_LoaiCK Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Max(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select max(" + nameColumn + ") from DM_LoaiCK"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MaxWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Max(" + nameColumn + ") From DM_LoaiCK Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Sum(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From DM_LoaiCK"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _SumWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From DM_LoaiCK Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public string _CreateID(string ColumnName, string Character, SqlConnection conn)
		{
			...
			if (conn.ConnectionString != "")
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select isnull(max(cast(substring(" + ColumnName + ",5,10) as decimal)),0) From DM_LoaiCK"
				};
				SqlDataReader reader = command.ExecuteReader();
				while (reader.Read())
				{
