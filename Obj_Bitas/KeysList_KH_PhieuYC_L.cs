...
namespace Bitas
{
	public class KeysList_KH_PhieuYC_L
	{
		...
		//ListAll
		public List<Ob_KH_PhieuYC_L> _ListAll(SqlConnection conn)
		{
			...
			conn.Open();
			List<Ob_KH_PhieuYC_L> list = new List<Ob_KH_PhieuYC_L>();
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_PhieuYC_L, ID_PhieuYC_H, ID_Barcode, MaSanPham, TenMau, Size, SoLuong, SoLuongDN, DonGia, ThanhTien, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy From KH_PhieuYC_L"
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
				Ob_KH_PhieuYC_L ob = new Ob_KH_PhieuYC_L();
				if(reader[0] != DBNull.Value){ ob.ID_PHIEUYC_L = Convert.ToString(reader[0]);}
				if(reader[1] != DBNull.Value){ ob.ID_PHIEUYC_H = Convert.ToString(reader[1]);}
				...
				if(reader[7] != DBNull.Value){ ob.SOLUONGDN = Convert.ToInt32(reader[7]);}
				if(reader[8] != DBNull.Value){ ob.DONGIA = Convert.ToDouble(reader[8]);}
		...
		//ListAll
		public List<Ob_KH_PhieuYC_L> _ListAll_sp(string StoredName, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//ListWhere
		public List<Ob_KH_PhieuYC_L> _ListWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_PhieuYC_L, ID_PhieuYC_H, ID_Barcode, MaSanPham, TenMau, Size, SoLuong, SoLuongDN, DonGia, ThanhTien, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy From KH_PhieuYC_L Where "+ keyword +""
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
		...
		//ListWhere_sp
		public List<Ob_KH_PhieuYC_L> _ListWhere_sp(string StoredName, SqlParameter[] ArrayParameter, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//GetObWhere
		public Ob_KH_PhieuYC_L _GetObWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//Insert ob
		public bool _InsertOb(Ob_KH_PhieuYC_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into KH_PhieuYC_L (ID_PhieuYC_H, ID_Barcode, MaSanPham, TenMau, Size, SoLuong, SoLuongDN, DonGia, ThanhTien, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy) Values(@ID_PhieuYC_H, @ID_Barcode, @MaSanPham, @TenMau, @Size, @SoLuong, @SoLuongDN, @DonGia, @ThanhTien, @ModifiedTime, @ModifiedBy, @CreatedTime, @CreatedBy)"
			};
			//command.Parameters.Add("ID_PhieuYC_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_PHIEUYC_L);
			...
			command.Parameters.Add("SoLuongDN", SqlDbType.Int).Value = ob.SOLUONGDN;
		...
		//InsertobGetId
		public int _InsertObGetId(Ob_KH_PhieuYC_L ob, SqlConnection conn)
		{
			int num = 0;
			if (conn.ConnectionString != "")
			{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into KH_PhieuYC_L (ID_PhieuYC_L, ID_PhieuYC_H, ID_Barcode, MaSanPham, TenMau, Size, SoLuong, SoLuongDN, DonGia, ThanhTien, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy) Values(@ID_PhieuYC_L, @ID_PhieuYC_H, @ID_Barcode, @MaSanPham, @TenMau, @Size, @SoLuong, @SoLuongDN, @DonGia, @ThanhTien, @ModifiedTime, @ModifiedBy, @CreatedTime, @CreatedBy)Select @@IDENTITY"
			};
			command.Parameters.Add("ID_PhieuYC_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_PHIEUYC_L);
			command.Parameters.Add("ID_PhieuYC_H", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_PHIEUYC_H);
			command.Parameters.Add("ID_Barcode", SqlDbType.BigInt).Value = ob.ID_BARCODE;
		...
		//UpdateOb ob
		public bool _UpdateOb(Ob_KH_PhieuYC_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Update KH_PhieuYC_L Set ID_PhieuYC_H=@ID_PhieuYC_H, ID_Barcode=@ID_Barcode, MaSanPham=@MaSanPham, TenMau=@TenMau, Size=@Size, SoLuong=@SoLuong, SoLuongDN=@SoLuongDN, DonGia=@DonGia, ThanhTien=@ThanhTien, ModifiedTime=@ModifiedTime, ModifiedBy=@ModifiedBy, CreatedTime=@CreatedTime, CreatedBy=@CreatedBy Where ID_PhieuYC_L=@ID_PhieuYC_L"
			};
			command.Parameters.Add("ID_PhieuYC_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_PHIEUYC_L);
			command.Parameters.Add("ID_PhieuYC_H", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_PHIEUYC_H);
			command.Parameters.Add("ID_Barcode", SqlDbType.BigInt).Value = ob.ID_BARCODE;
		...
		//DeleteOB
		public bool _DeleteOb(Ob_KH_PhieuYC_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Delete From KH_PhieuYC_L Where ID_PhieuYC_L=@ID_PhieuYC_L"
			};
				command.Parameters.Add(new SqlParameter("ID_PhieuYC_L", ob.ID_PHIEUYC_L));
			try
			{
				command.ExecuteNonQuery();
			}
		...
		public bool _DeleteWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Delete From KH_PhieuYC_L Where " + condition
			};
			try
			{
				command.ExecuteNonQuery();
		...
		public bool _CheckWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select * From KH_PhieuYC_L Where " + condition
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Count(string nameColumn, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From KH_PhieuYC_L"
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _CountWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From KH_PhieuYC_L Where " + keyword +""
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Min(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From KH_PhieuYC_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MinWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From KH_PhieuYC_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Max(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select max(" + nameColumn + ") from KH_PhieuYC_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MaxWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Max(" + nameColumn + ") From KH_PhieuYC_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Sum(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From KH_PhieuYC_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _SumWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From KH_PhieuYC_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public string _CreateID(string ColumnName, string Character, SqlConnection conn)
		{
			...
			if (conn.ConnectionString != "")
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select isnull(max(cast(substring(" + ColumnName + ",5,10) as decimal)),0) From KH_PhieuYC_L"
				};
				SqlDataReader reader = command.ExecuteReader();
				while (reader.Read())
				{
