...
//CreateTimes : 17/03/2017 15:36:04.PM

namespace Bitas
{
	public class KeysList_POS_KhuyenMaiKhoangGiaHoaDon
	{
		...
		//ListAll
		public List<Ob_POS_KhuyenMaiKhoangGiaHoaDon> _ListAll(SqlConnection conn)
		{
			...
			conn.Open();
			List<Ob_POS_KhuyenMaiKhoangGiaHoaDon> list = new List<Ob_POS_KhuyenMaiKhoangGiaHoaDon>();
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_KhoangGia, ID_KhuyenMai, TuGiaTri, DenGiaTri, GiamGiaPT, GiamGiaTien, ID_SanPham, SoLuong, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy From POS_KhuyenMaiKhoangGiaHoaDon"
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
				Ob_POS_KhuyenMaiKhoangGiaHoaDon ob = new Ob_POS_KhuyenMaiKhoangGiaHoaDon();
		...
		//ListAll
		public List<Ob_POS_KhuyenMaiKhoangGiaHoaDon> _ListAll_sp(string StoredName, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//ListWhere
		public List<Ob_POS_KhuyenMaiKhoangGiaHoaDon> _ListWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_KhoangGia, ID_KhuyenMai, TuGiaTri, DenGiaTri, GiamGiaPT, GiamGiaTien, ID_SanPham, SoLuong, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy From POS_KhuyenMaiKhoangGiaHoaDon Where "+ keyword +""
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
		...
		//ListWhere_sp
		public List<Ob_POS_KhuyenMaiKhoangGiaHoaDon> _ListWhere_sp(string StoredName, SqlParameter[] ArrayParameter, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//GetObWhere
		public Ob_POS_KhuyenMaiKhoangGiaHoaDon _GetObWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//Insert ob
		public bool _InsertOb(Ob_POS_KhuyenMaiKhoangGiaHoaDon ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into POS_KhuyenMaiKhoangGiaHoaDon (ID_KhuyenMai, TuGiaTri, DenGiaTri, GiamGiaPT, GiamGiaTien, ID_SanPham, SoLuong, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy) Values(@ID_KhuyenMai, @TuGiaTri, @DenGiaTri, @GiamGiaPT, @GiamGiaTien, @ID_SanPham, @SoLuong, @ModifiedTime, @ModifiedBy, @CreatedTime, @CreatedBy)"
			};
		...
		//InsertobGetId
		public int _InsertObGetId(Ob_POS_KhuyenMaiKhoangGiaHoaDon ob, SqlConnection conn)
		{
			int num = 0;
			if (conn.ConnectionString != "")
			{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into POS_KhuyenMaiKhoangGiaHoaDon (ID_KhuyenMai, TuGiaTri, DenGiaTri, GiamGiaPT, GiamGiaTien, ID_SanPham, SoLuong, ModifiedTime, ModifiedBy, CreatedTime, CreatedBy) Values(@ID_KhuyenMai, @TuGiaTri, @DenGiaTri, @GiamGiaPT, @GiamGiaTien, @ID_SanPham, @SoLuong, @ModifiedTime, @ModifiedBy, @CreatedTime, @CreatedBy)Select @@IDENTITY"
			};
			command.Parameters.Add("ID_KhuyenMai", SqlDbType.Int).Value = ob.ID_KHUYENMAI;
			command.Parameters.Add("TuGiaTri", SqlDbType.Money).Value = ob.TUGIATRI;
			command.Parameters.Add("DenGiaTri", SqlDbType.Money).Value = ob.DENGIATRI;
		...
		//UpdateOb ob
		public bool _UpdateOb(Ob_POS_KhuyenMaiKhoangGiaHoaDon ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
		...
		//DeleteOB
		public bool _DeleteOb(Ob_POS_KhuyenMaiKhoangGiaHoaDon ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Delete From POS_KhuyenMaiKhoangGiaHoaDon Where ID_KhoangGia=@ID_KhoangGia"
			};
		...
		public bool _DeleteWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Delete From POS_KhuyenMaiKhoangGiaHoaDon Where " + condition
			};
			try
			{
				command.ExecuteNonQuery();
		...
		public bool _CheckWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select * From POS_KhuyenMaiKhoangGiaHoaDon Where " + condition
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Count(string nameColumn, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon"
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _CountWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon Where " + keyword +""
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Min(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MinWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Max(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select max(" + nameColumn + ") from POS_KhuyenMaiKhoangGiaHoaDon"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MaxWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Max(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Sum(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _SumWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From POS_KhuyenMaiKhoangGiaHoaDon Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public string _CreateID(string ColumnName, string Character, SqlConnection conn)
		{
			...
			if (conn.ConnectionString != "")
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select isnull(max(cast(substring(" + ColumnName + ",5,10) as decimal)),0) From POS_KhuyenMaiKhoangGiaHoaDon"
				};
				SqlDataReader reader = command.ExecuteReader();
				while (reader.Read())
				{
