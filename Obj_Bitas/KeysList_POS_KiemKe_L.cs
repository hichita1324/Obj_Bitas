...
//CreateTimes : 04/07/2018 16:23:26.PM

namespace Bitas
{
	public class KeysList_POS_KiemKe_L
	{
		...
		//ListAll
		public List<Ob_POS_KiemKe_L> _ListAll(SqlConnection conn)
		{
			...
			conn.Open();
			List<Ob_POS_KiemKe_L> list = new List<Ob_POS_KiemKe_L>();
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_KiemKe_L, ID_KiemKe_H, ID_Barcode, MaSanPham, TenMau, Size, DonGia, SoLuong, NguyenGia, ThanhTien, PhePham, CreatedTime, CreatedBy, ModifiedTime, ModifiedBy From POS_KiemKe_L"
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
				Ob_POS_KiemKe_L ob = new Ob_POS_KiemKe_L();
				if(reader[0] != DBNull.Value){ ob.ID_KIEMKE_L = Convert.ToString(reader[0]);}
				if(reader[1] != DBNull.Value){ ob.ID_KIEMKE_H = Convert.ToString(reader[1]);}
				...
				if(reader[10] != DBNull.Value){ ob.PHEPHAM = Convert.ToBoolean(reader[10]);}
				...
				if(reader[13] != DBNull.Value){ ob.MODIFIEDTIME = Convert.ToDateTime(reader[13]);}
				if(reader[14] != DBNull.Value){ ob.MODIFIEDBY = Convert.ToString(reader[14]);}
				list.Add(ob);
			}
			command.Dispose();
			command = null;
		...
		//ListAll
		public List<Ob_POS_KiemKe_L> _ListAll_sp(string StoredName, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//ListWhere
		public List<Ob_POS_KiemKe_L> _ListWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Select ID_KiemKe_L, ID_KiemKe_H, ID_Barcode, MaSanPham, TenMau, Size, DonGia, SoLuong, NguyenGia, ThanhTien, PhePham, CreatedTime, CreatedBy, ModifiedTime, ModifiedBy From POS_KiemKe_L Where "+ keyword +""
			};
			SqlDataReader reader = command.ExecuteReader();
			while (reader.Read())
			{
		...
		//ListWhere_sp
		public List<Ob_POS_KiemKe_L> _ListWhere_sp(string StoredName, SqlParameter[] ArrayParameter, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//GetObWhere
		public Ob_POS_KiemKe_L _GetObWhere(string keyword, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return null;
		...
		//Insert ob
		public bool _InsertOb(Ob_POS_KiemKe_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into POS_KiemKe_L (ID_KiemKe_L, ID_KiemKe_H, ID_Barcode, MaSanPham, TenMau, Size, DonGia, SoLuong, NguyenGia, ThanhTien, PhePham, CreatedTime, CreatedBy, ModifiedTime, ModifiedBy) Values(@ID_KiemKe_L, @ID_KiemKe_H, @ID_Barcode, @MaSanPham, @TenMau, @Size, @DonGia, @SoLuong, @NguyenGia, @ThanhTien, @PhePham, @CreatedTime, @CreatedBy, @ModifiedTime, @ModifiedBy)"
			};
			command.Parameters.Add("ID_KiemKe_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_KIEMKE_L);
			...
			command.Parameters.Add("PhePham", SqlDbType.Bit).Value = ob.PHEPHAM;
		...
		//InsertobGetId
		public int _InsertObGetId(Ob_POS_KiemKe_L ob, SqlConnection conn)
		{
			int num = 0;
			if (conn.ConnectionString != "")
			{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Insert Into POS_KiemKe_L (ID_KiemKe_L, ID_KiemKe_H, ID_Barcode, MaSanPham, TenMau, Size, DonGia, SoLuong, NguyenGia, ThanhTien, PhePham, CreatedTime, CreatedBy, ModifiedTime, ModifiedBy) Values(@ID_KiemKe_L, @ID_KiemKe_H, @ID_Barcode, @MaSanPham, @TenMau, @Size, @DonGia, @SoLuong, @NguyenGia, @ThanhTien, @PhePham, @CreatedTime, @CreatedBy, @ModifiedTime, @ModifiedBy)Select @@IDENTITY"
			};
			command.Parameters.Add("ID_KiemKe_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_KIEMKE_L);
			command.Parameters.Add("ID_KiemKe_H", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_KIEMKE_H);
			command.Parameters.Add("ID_Barcode", SqlDbType.BigInt).Value = ob.ID_BARCODE;
		...
		//UpdateOb ob
		public bool _UpdateOb(Ob_POS_KiemKe_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Update POS_KiemKe_L Set ID_KiemKe_H=@ID_KiemKe_H, ID_Barcode=@ID_Barcode, MaSanPham=@MaSanPham, TenMau=@TenMau, Size=@Size, DonGia=@DonGia, SoLuong=@SoLuong, NguyenGia=@NguyenGia, ThanhTien=@ThanhTien, PhePham=@PhePham, CreatedTime=@CreatedTime, CreatedBy=@CreatedBy, ModifiedTime=@ModifiedTime, ModifiedBy=@ModifiedBy Where ID_KiemKe_L=@ID_KiemKe_L"
			};
			command.Parameters.Add("ID_KiemKe_L", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_KIEMKE_L);
			command.Parameters.Add("ID_KiemKe_H", SqlDbType.UniqueIdentifier).Value = new SqlGuid(ob.ID_KIEMKE_H);
			command.Parameters.Add("ID_Barcode", SqlDbType.BigInt).Value = ob.ID_BARCODE;
		...
		//DeleteOB
		public bool _DeleteOb(Ob_POS_KiemKe_L ob, SqlConnection conn)
		{
			if (conn.ConnectionString == "")
			{
				return false;
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = @"Delete From POS_KiemKe_L Where ID_KiemKe_L=@ID_KiemKe_L"
			};
				command.Parameters.Add(new SqlParameter("ID_KiemKe_L", ob.ID_KIEMKE_L));
			try
			{
				command.ExecuteNonQuery();
			}
		...
		public bool _DeleteWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Delete From POS_KiemKe_L Where " + condition
			};
			try
			{
				command.ExecuteNonQuery();
		...
		public bool _CheckWhere(string condition, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand
			{
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select * From POS_KiemKe_L Where " + condition
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Count(string nameColumn, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From POS_KiemKe_L"
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _CountWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			SqlCommand command = new SqlCommand {
				Connection = conn,
				CommandType = CommandType.Text,
				CommandText = "Select Count(" + nameColumn + ") From POS_KiemKe_L Where " + keyword +""
			};
			try
			{
				SqlDataReader reader = command.ExecuteReader();
		...
		public double _Min(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From POS_KiemKe_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MinWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Min(" + nameColumn + ") From POS_KiemKe_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Max(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select max(" + nameColumn + ") from POS_KiemKe_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _MaxWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Max(" + nameColumn + ") From POS_KiemKe_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _Sum(string nameColumn, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From POS_KiemKe_L"
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public double _SumWhere(string nameColumn, string keyword, SqlConnection conn)
		{
			...
			if (this._Count(nameColumn,conn) != 0)
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select Sum(" + nameColumn + ") From POS_KiemKe_L Where " + keyword +""
				};
				try
				{
					SqlDataReader reader = command.ExecuteReader();
		...
		public string _CreateID(string ColumnName, string Character, SqlConnection conn)
		{
			...
			if (conn.ConnectionString != "")
			{
				...
				SqlCommand command = new SqlCommand
				{
					Connection = conn,
					CommandType = CommandType.Text,
					CommandText = "Select isnull(max(cast(substring(" + ColumnName + ",5,10) as decimal)),0) From POS_KiemKe_L"
				};
				SqlDataReader reader = command.ExecuteReader();
				while (reader.Read())
				{
