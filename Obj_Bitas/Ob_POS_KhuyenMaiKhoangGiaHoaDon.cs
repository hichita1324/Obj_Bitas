...
namespace Bitas
{
	public class Ob_POS_KhuyenMaiKhoangGiaHoaDon
	{
		...
		public Ob_POS_KhuyenMaiKhoangGiaHoaDon()
		{
			id_khuyenmai = 0;
			tugiatri = 0;
			dengiatri = 0;
		...
		public Ob_POS_KhuyenMaiKhoangGiaHoaDon( long new_id_khoanggia, int new_id_khuyenmai, double new_tugiatri, double new_dengiatri, double new_giamgiapt, double new_giamgiatien, long new_id_sanpham, int new_soluong, DateTime new_modifiedtime, string new_modifiedby, DateTime new_createdtime, string new_createdby)	
		{
		...
		public Ob_POS_KhuyenMaiKhoangGiaHoaDon(Ob_POS_KhuyenMaiKhoangGiaHoaDon newOb)
		{
